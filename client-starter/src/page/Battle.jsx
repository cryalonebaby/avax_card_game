...
import { Alert, ActionButton, PlayerInfo, Card, GameInfo } from '../components';
...
const Battle = () => {
	...
	const makeAMove = async (choice) => {
		...
		try {
			//* contract.methods return UNDEFINED

			// const gasLimit = await contract.methods
			// 	.attackOrDefendChoice(choice, battleName)
			// 	.estimateGas();
			// await contract.methods.attackOrDefendChoice(choice, battleName).send({
			// 	gasLimit: gasLimit,
			// });

			//* in this way we can't trigger catch block
